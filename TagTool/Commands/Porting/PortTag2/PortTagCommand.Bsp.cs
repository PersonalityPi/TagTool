...
namespace TagTool.Commands.Porting
{
    ...
    {
        private ScenarioStructureBsp ConvertScenarioStructureBsp(CacheFile blam_cache, ScenarioStructureBsp sbsp, CachedTagInstance instance, Dictionary<ResourceLocation, Stream> resourceStreams)
        {
            sbsp.CollisionBspResource = ConvertStructureBspTagResources(blam_cache, sbsp, resourceStreams);
            sbsp.PathfindingResource = ConvertStructureBspCacheFileTagResources(blam_cache, sbsp, resourceStreams);
