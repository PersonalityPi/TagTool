...
namespace TagTool.Commands.Porting
{
    ...
    {
        private MultilingualUnicodeStringList ConvertMultilingualUnicodeStringList(CacheFile blam_cache, List<ConvertTagTask> tag_conversion_tasks, Stream cacheStream, Dictionary<ResourceLocation, Stream> resourceStreams, MultilingualUnicodeStringList unic)
        {
            ...
            var localeTable = blam_cache.LocaleTables;
            ...
            for(int i = begin; i < begin + count; i++)
            {
                ...
                var stringBlock = new LocalizedString {
                    StringID = (StringId)ConvertData(blam_cache, tag_conversion_tasks, cacheStream, resourceStreams, new StringId((uint)pair.Key, blam_cache_version), null, null),
                    StringIDStr = null,
                };
