...
namespace TagTool.Commands.Porting
{
    partial class PortTag2Command
    {
        ...
        private ScenarioLightmap ConvertScenarioLightmap(CacheFile blam_cache, List<ConvertTagTask> tag_conversion_tasks, Stream cacheStream, Dictionary<ResourceLocation, Stream> resourceStreams, string blamTagName, ScenarioLightmap scenarioLightmap)
        {
            ...
            foreach (var entry in scenarioLightmap.Lightmaps)
            {
                ...
                var Lbsp = (ScenarioLightmapBspData)ConvertData(blam_cache, tag_conversion_tasks, cacheStream, resourceStreams, entry, scenarioLightmap, blamTagName);
